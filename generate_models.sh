...
function generate_model {
	...
	./run_learning.sh -i $INPUT_DIR -t $TEST_DIR -p "${PATTERN}" -o ./generated_models/model_${PREFIXE}_$1.xml
}
...
./generate_models.sh loris ../Documents/ml/loris_img_HOG ../Documents/ml/others_img_HOG/ > model_gen.log
